...
class MainThread(QThread):
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            elif ('open teams'in self.command) or ('open stream'in self.command) or ('open sharepoint'in self.command) or('open outlook'in self.command)or('open amrita portal'in self.command)or('open octave'in self.command) or ("open sis login"in self.command):
    ...
    def Fun(self,command):
        ...
        if 'your name' in command:
            ...
            self.talk("your name is Tharun")
        elif 'university name' in command:
            self.talk("you are studing in kalasalingam, with batchlour in Computer Science and Artificail Intelligence") 
    ...
    def college(self,command):
        ...
        if 'teams' in command:
            ...
            self.talk('opening your Kalasalingam university management system')
            webbrowser.open('https://student.kalasalingam.ac.in/login')
    ...
    def open_source(self,command):
        ...
        if 'github' in command:
            ...
            webbrowser.open('https://github.com/TharunNarra')
    ...
    def SendEmail(self,to,content):
        ...
        server.ehlo()
        server.starttls()
        server.login("tharunnarra43@gmail.com","kdlz tbpl jjyz dvkl")
        server.sendmail("tharunnarra10@gmail.com",to,content)
        server.close()
